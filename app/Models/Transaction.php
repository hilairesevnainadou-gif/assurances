...
class Transaction extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($transaction) {
            // Générer transaction_id si vide
            if (empty($transaction->transaction_id)) {
                $transaction->transaction_id = self::generateTransactionId();
            }

            // Générer reference si vide
            if (empty($transaction->reference)) {
                $transaction->reference = 'REF-' . $transaction->transaction_id;
            }

            // Définir total_amount si non fourni
            ...
            // Définir payment_method par défaut
